      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sign in to your PyLibHub account</p>
          </div>

          {/* Form */}
          <motion.div
            className="glass-card backdrop-blur-xl bg-white/5 border border-white/10 shadow-2xl hover:glow-primary transition-all duration-300"
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full gradient-primary text-primary-foreground font-medium h-12 glass-button"
              >
                {isLoading ? (
                  <motion.div
